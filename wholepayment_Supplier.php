...
$data_sql="SELECT * FROM `trays` where category='Supplier' and (date >='$from' AND date<='$to')";
//group by name
...
$row;
        ...
        // $pdf->Ln(44);
        $pdf->SetFont('Arial','B',18);
        $pdf->Cell(180,10,'Tray Wise - Supplier',0,0,'C');
        $pdf->Ln(10);
...
$pdf->Ln(10);
    ...
    //   $pdf->Ln(20);
      ...
      $pdf->Cell(25,10,'Supplier',0,0,'R',true);
