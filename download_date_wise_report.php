...
$objPHPExcel ->getActiveSheet()->setTitle("Get Date Wise Report");
...
if(mysqli_num_rows($res)>0)
{
    ...
    while($approval_row = mysqli_fetch_object($res)) {
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('F'.($i), $approval_row->description);
