                  ...
                  -->
                     <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title">View Quality Name List</h4>
                           </div>
                        </div>
                        <div class="iq-card-body card1">
                           ...
                           <div class="col-md-6">
                              ...
                              <div class="col-md-6">
                              <button type="button" id="add" name="add" style="color: #fff;" class="btn btn-warning mymodalQuality">Add Quality Item</button>
                              </div>
                            </div>
...
if(isset($_POST["add_quality"]))
{
    ...
    $add_quality_query="insert into `quality` SET quality_name='$quality_name'";
     $quality_sql= $connect->prepare($add_quality_query);
                            
    if($quality_sql->execute())
    {
...
// $.fn.dataTableExt.sErrMode = 'throw';
    $(document).ready(function(){
       var table=$('#example').DataTable({
            ...
            "ajax": {
                "url": "forms/ajax_request.php?action=view_add_item",
                "type": "POST"
            },
            "columns": [
            ...
            columnDefs: [
               {
                ...
                },
                {
                    targets: 2,
                    render: function(data, type, row) {
                        return '<?php if($user_role=="admin") { ?>
                        <a href="Add-item_demo.php?req=delete&id='+row.id+'"><span style="cursor:pointer;color:red;"><i class="bx bx-trash" ></i></span></a><?php }?>';
                    }
                }
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <form method="post">
                                       <div class="form-group">
                                          <label for="cpass">Quality Name</label>
                                         
                                             <input type="text" required class="form-control" name="quality_name">
                                          </div>
                                          <input type="submit" name="add_quality"class="btn btn-primary mr-2" value="Submit">
