...
$objPHPExcel ->getActiveSheet()->setTitle("Get Return Report");
...
$objPHPExcel->getActiveSheet()->setTitle("Get Return Settled Report");

$sql=" SELECT * FROM `sar_stock` WHERE (date>='".$from."' AND date<='".$to."') AND return_status=1 ";
...
$filename="Get Return Settled Report";
