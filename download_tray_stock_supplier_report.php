...
$objPHPExcel ->getActiveSheet()->setTitle("Get Tray Stock Supplier Report");
...
//SELECT name, category, date ,(SUM(outward) - SUM(inward)) as balance FROM `tray_transactions` WHERE category='Supplier'

$sql="SELECT * FROM `tray_transactions` WHERE category='Supplier' AND (date>='".$from."' AND date<='".$to."')";
...
//exit;
$filename="Get Tray Stock Supplier Report";
