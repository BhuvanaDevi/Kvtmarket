...
//print_r($_REQUEST);
$from_supplier = $_REQUEST["from_supplier"];
$to_supplier = $_REQUEST["to_supplier"];
...
$sql="SELECT * FROM `tray_transactions` WHERE (date>='".$from_supplier."' AND date<='".$to_supplier."') AND category='Supplier'";
...
//exit;
$filename="Get Tray Inventory Supplier Report";
