...
$objPHPExcel->getActiveSheet()->setTitle("Get Stock Settled Report");

$sql=" SELECT * FROM `sar_stock` WHERE (date>='".$from."' AND date<='".$to."') AND payment_status=1 ";
...
$filename="Get Stock Settled Report";
