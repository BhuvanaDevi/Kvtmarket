...
$sel_qry2 = "SELECT * FROM `financial_transactions` WHERE ids='$supplier' order by id desc limit 1";
$data_qry2= $connect->prepare($sel_qry2);
$data_qry2->execute();
...
$sel_qryn = "SELECT * FROM `financial_transactions` WHERE (date >='$from' AND date<='$to')";
...
$row;
        ...
        // $pdf->Ln(44);
        $pdf->SetFont('Arial','B',18);
        $pdf->Cell(180,10,'Date Wise Report - All',0,0,'C');
        $pdf->Ln(10);
...
$pdf->Ln(10);
    ...
    //    $pdf->SetFont('Arial','',14);
      ...
      $pdf->Cell(70,10,'Particulars',0,0,'R',true);
      // $pdf->Cell(30,10,'Category',0,0,'R',true);
      $pdf->Cell(25,10,'Credit',0,0,'R',true);
      $pdf->Cell(25,10,'Debit',0,0,'R',true);
...
$tot = "SELECT *,SUM(total_bill_amount) as tot FROM `sar_patti` WHERE pat_id='$saleid'";
...
// print_r($tota);
      ...
      //   }
       ...
       $pdf->Cell(70,10,$result['description'],0,0,'R');
       $pdf->Cell(25,10,$result['credit'],0,0,'R');
        $pdf->Cell(25,10,$result['debit'],0,0,'R');
