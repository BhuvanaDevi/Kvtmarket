...
$sql = "SELECT * FROM  sar_sales_invoice WHERE (date >= '$from' and date <= '$to') and is_active=0 and nullify=0";
...
$row;
        ...
        $pdf->Cell(180,10,'Sales Invoice Settled Report - Customer',0,0,'C');
        $pdf->Ln(10);
