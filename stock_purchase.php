                    ...
                    <div class="iq-card-body">
                        <form method="post" action="#" class="searchbox">
                            <div class="row col-md-12">
                                ...
                                ?>
                                <input type="text" class="form-control" id="purchase_id" name="purchase_id" value="<?=$purchase_id?>" readonly>
                            </div>
                            <div class="form-group col-md-6">
                          ...
                          <input list="grp_name" class="form-control" name="grpname" id="grpname">
                           ...
                           <input list="searchval" id="search_val" class="form-control" name="search_val">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input list="quality_name" class="form-control" name="qualityname" required id="qualityname">
                        <datalist class="quality_name" id="quality_name" name="quality_name">
                            ...
                            <div class="form-group col-md-6">
                             ...
                             <input type="number" class="form-control" name="quantity" required id="quantity" min="0">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="exampleInputNumber1">Rate</label><span style="color:red">*</span>
                                <input type="number" class="form-control" name="rate" required id="rate" min="0">
                            </div>
                            </div>
                            <div class="row col-md-12">
                            <div class="form-group col-md-6">
